        ...
        <div className="rounded-3xl border border-black/10 bg-white/[0.02] backdrop-blur-sm shadow-[0_0_50px_-25px_rgba(255,255,255,0.5)] overflow-hidden">
          <div className="p-6 sm:p-10 space-y-6 text-center">
            ...
            <div className="flex justify-center gap-3">
              <Link
                href="/"
                className="inline-flex items-center justify-center px-7 py-3.5 rounded-full border border-white/20 hover:border-black/100 hover:bg-white/5 transition-colors font-body font-semibold text-sm"
              >
                Back
              </Link>
              <Link
