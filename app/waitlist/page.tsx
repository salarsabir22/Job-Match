        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-sm shadow-[0_0_50px_-25px_rgba(247,147,26,0.5)] overflow-hidden">
          <div className="p-6 sm:p-10 space-y-6 text-center">
            ...
            <div className="flex justify-center gap-3">
              ...
              <Link
                href="/auth/signup"
                className="inline-flex items-center justify-center px-7 py-3.5 rounded-full bg-gradient-to-r from-[#EA580C] to-[#F7931A] text-white font-body font-semibold text-sm tracking-wide hover:scale-[1.01] transition-all duration-200"
              >
                Sign up
              </Link>
            </div>
