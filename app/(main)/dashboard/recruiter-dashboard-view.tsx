    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-4 min-w-0">
          ...
          <div>
            <p className="font-data text-[10px] tracking-[0.2em] uppercase text-muted-foreground">Recruiter Dashboard</p>
        ...
        <Link
          href="/jobs/new"
          className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-primary text-primary-foreground text-xs font-semibold w-fit transition hover:bg-[var(--clearpath-navy-hover)]"
        >
          Post job
        </Link>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          ...
          <div key={label} className="rounded-xl border border-border bg-card p-4">
            <p className="font-data text-[9px] tracking-wider uppercase text-muted-foreground">{label}</p>
      ...
      <div>
        <p className="font-data text-[10px] tracking-widest uppercase text-muted-foreground mb-1">Last 30 days</p>
