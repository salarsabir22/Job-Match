      ...
      {pendingRecruiters.length > 0 && (
        <div className="rounded-xl bg-[#0F1115] border border-white/8 p-5 space-y-4">
          ...
          <Link href="/admin/recruiters"
            className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-gradient-to-r from-[#525252] to-[#FAFAFA] text-white font-body font-semibold text-sm shadow-[0_0_20px_-5px_rgba(255,255,255,0.4)] hover:shadow-[0_0_30px_-5px_rgba(255,255,255,0.6)] transition-all duration-300">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {[
          ...
          <Link key={href} href={href}>
            <div className="rounded-xl bg-[#0F1115] border border-white/8 p-4 hover:border-[#FAFAFA]/25 hover:shadow-[0_0_15px_-5px_rgba(255,255,255,0.1)] transition-all duration-300 h-full">
